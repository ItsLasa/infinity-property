            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-[0_10px_50px_rgba(0,0,0,0.05)] border border-gray-100 relative z-10">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        ...
                        <Link to="/login" className="font-medium text-emerald-800 hover:text-emerald-700 underline underline-offset-4">
                            Sign in here
                        </Link>
                    </p>
                </div>
                <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className="rounded-md space-y-4">
                        <div>
                            <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1 block">Full Name</label>
                        ...
                        <div>
                            <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1 block">Confirm Password</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <Lock className="h-5 w-5 text-gray-400" />
                                </div>
